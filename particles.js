import { Renderer, Camera, Geometry, Program, Mesh } from "./node_modules/ogl/src/index.js";
...
export function createParticles(container, options = {}) {
  ...
  if (moveParticlesOnHover) {
    // pointermove covers mouse hover without requiring a button press
    window.addEventListener("pointermove", handlePointerMove, pointerListenerOptions);
    // Fallback for older browsers
    window.addEventListener("mousemove", handlePointerMove, pointerListenerOptions);
  }
  ...
  return () => {
    ...
    if (moveParticlesOnHover) {
      ...
      window.removeEventListener("mousemove", handlePointerMove, pointerListenerOptions);
    }
